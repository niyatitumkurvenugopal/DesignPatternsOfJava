 ...
 * As we've been changing the state of our context i.e Package in this case, the behavior was changing
 ...
 * In this it will be open for extension of behavior(for this different states)but without modifying the source code.
 */
