...
For good coding we need to abstract out which is different that is make a different class and put just those things that are different inside the subclasses.
 */